...
# script2 = '/home/harim/ai_finalproject/CoOp/scripts/cocoop/base2new_train_promptotype.sh'
script2 = '/home/harim/ai_finalproject/CoOp/scripts/cocoop/all/all_train_promptotype.sh'
...
#         try:
#             os.system(f"bash {script2} {dataset} 1 10")
#         except:
