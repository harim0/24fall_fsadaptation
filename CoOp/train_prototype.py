...
import trainers.cocoop_prototype
from trainers.cocoop_prototype import CoCoOp_Prototype
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COCOOP_PROTOTYPE = CN()
    cfg.TRAINER.COCOOP_PROTOTYPE.N_CTX = 16  # number of context vectors
    cfg.TRAINER.COCOOP_PROTOTYPE.CTX_INIT = ""  # initialization words
    cfg.TRAINER.COCOOP_PROTOTYPE.PREC = "fp16"  # fp16, fp32, amp
